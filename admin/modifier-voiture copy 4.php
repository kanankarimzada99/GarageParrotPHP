...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (!$errors) {
    ...
    $res = saveCar($pdo, $_POST['brand'], $_POST['model'], $_POST['year'], $_POST['kilometer'], $_POST['gearbox'], $_POST['doors'], $_POST['price'], $_POST['color'], $_POST['fuel'], $_POST['co2'], $_POST["car-image"], $id);
          ...
          <div class="car-description">
            ...
            <div class="car-description-right">
              ...
              <div class="form-group">
                ...
                <label for="car-image">Choisissez une image de voiture:</label>
                <input type="hidden" name="car-image" value="<?= htmlspecialchars($car['image'] ?? $fileName) ; ?>">
              </div>
