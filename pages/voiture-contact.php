  ...
  <?php if ($car) : ?>
          ...
          <div class="contact-form">
            <div class="contact-form-left">
              <div class="form-group">
                ...
                <input type="text" name="lastname" id="lastname" minlength="5" maxlength="25" placeholder="Dupont" autocomplete="off">
            ...
            <div class="contact-form-right">
              ...
              <div class="form-group">
                ...
                <textarea name="message" id="message" cols="30" rows="5" autocomplete="off" minlength="15" maxlength="250"></textarea>
                <span class="error" id="message_err"> </span>
              </div>
            </div>
          </div>

          <img src="<?= $imagePath; ?>" alt="<?= $_SESSION['car']['brand'] . " " . $_SESSION['car']['model'] ?>" class="w-25 image-car" loading="lazy">
    ...
    <?php else : ?>
      ...
      <div class="go-back-page my-3 d-flex justify-content-center">
        <a href="javascript:history.back(1)" class="btn-wire mb-5">Retourner page précédante</a>
      </div>
    <?php endif ?>
