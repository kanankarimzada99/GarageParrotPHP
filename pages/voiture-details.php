...
if (isset($_GET['id'])) {
  ...
  if ($car === false) {
    ...
    echo "<div class='d-flex justify-content-center w-25 alert alert-danger mt-5 mb-3 mx-auto'  role='alert' >Cette voiture n'existe pas</div>";
  }
                ...
                <div class="row my-3">
                  <?php foreach ($carImages as $car) { ?>
                    <div class="car-thumbnails-img col-6 col-sm-4 mb-3 ">
                      <img src="<?= _GARAGE_IMAGES_FOLDER_ . htmlspecialchars_decode($car['image_path']) ?>" alt="<?= $car['brand'] ?>" onmouseover='myFunction(this)'>
                    </div>
                  <?php } ?>
                </div>
              </div>
