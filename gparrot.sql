...
-- create services
INSERT INTO services(service, description, image) VALUES ('reparation de carrosserie','Notre equipe est especialise depuis 2 ans dans la reparation de carrosserie','01-eletric.jpg'),('Motor','Notre equipe repare ou replace totalmente votre motor','02-engine_repair.jpg'),('batterie','On travail avec les meilleurs marques des batterie du marché','03-car_battery.jpg');
